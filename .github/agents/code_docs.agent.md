...
5. If user asks to save to Feishu:
   - Load `.agents/skills/feishu-docs/SKILL.md`.
...
6. If user asks to commit/publish docs to GitHub:
   - Load `.agents/skills/github-publish/SKILL.md`.
...
- **Commit docs to GitHub**: When user says "提交文档"、"commit docs"、"推送到仓库"、"publish docs"、"发布文档", load `.agents/skills/github-publish/SKILL.md` and follow its workflow.
