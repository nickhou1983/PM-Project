...
| **Gate 2: 架构评审** | 架构文档完成后、进入开发前 | 架构文档 + PRD | 是否进入开发阶段 |
...
| # | 检查项 | 判定 | 说明 |
|---|--------|------|------|
| 6 | 需求追溯矩阵是否完整（PRD 功能 ↔ 架构模块） | ✅/⚠️/❌ | |
| 7 | PRD 非功能需求是否在架构中有对应方案 | ✅/⚠️/❌ | |
| 8 | 架构设计是否与 PRD 目标一致（无过度设计） | ✅/⚠️/❌ | |

#### C. 质量属性（权重 25%）

| # | 检查项 | 判定 | 说明 |
|---|--------|------|------|
| 9 | 性能方案是否有量化指标和推导逻辑 | ✅/⚠️/❌ | |
| 10 | 安全设计是否覆盖 OWASP Top 10 核心项 | ✅/⚠️/❌ | |
| 11 | 部署方案是否包含 CI/CD 和环境规划 | ✅/⚠️/❌ | |
| 12 | 高可用和容灾方案是否有说明 | ✅/⚠️/❌ | |
...
| # | 检查项 | 判定 | 说明 |
|---|--------|------|------|
| 13 | 技术风险是否已识别并有应对方案 | ✅/⚠️/❌ | |
| 14 | 架构债务是否有演进路线 | ✅/⚠️/❌ | |
| 15 | 成本估算是否合理（如涉及付费服务） | ✅/⚠️/❌ | |

#### E. 版本管理（权重 5%）

| # | 检查项 | 判定 | 说明 |
|---|--------|------|------|
| 16 | 架构文档「关联 PRD」字段是否包含精确版本号（如 `prd-xxx.md v1.0.0`） | ✅/⚠️/❌ | |
| 17 | 关联的 PRD 版本号是否与实际 PRD 文档头版本一致 | ✅/⚠️/❌ | |
| 18 | 架构文档头版本号与 §11 变更记录最新条目是否一致 | ✅/⚠️/❌ | |
| 19 | 状态字段是否为有效值（草稿/评审中/已批准/已替代） | ✅/⚠️/❌ | |
