...
| 3 | `ai-diagnosis` | AI 初诊 | 5 | P0 | [prd-ai-diagnosis.md](prd-ai-diagnosis.md) | 待生成 |
| 4 | `health-recommendation` | 保健品推荐 | 4 | P0 | [prd-health-recommendation.md](prd-health-recommendation.md) | 待生成 |
| 5 | `ecommerce` | 电商购物 | 6 | P0 | [prd-ecommerce.md](prd-ecommerce.md) | 待生成 |
